...
export default function AdminPage() {
  ...
  useEffect(() => {
    if (authenticated) {
      ...
      fetchPageContent()
        .then((data) => {
          if (data) setHeroForm((prev) => ({ ...prev, ...data }));
        })
  ...
  const addTech = () => {
    ...
    setForm((f) => ({
      ...f,
      techStack: { ...f.techStack, [name]: newTech.description.trim() },
    }));
  ...
  const buildPayload = (isNew = false): Omit<Project, "id"> => {
    ...
    return {
      ...
      ...(Object.keys(safeTechStack).length > 0 && {
  ...
  const addAboutItem = () => {
    ...
    setAboutForm({
      ...aboutForm,
      items: [...aboutForm.items, { icon: "✨", title: "", description: "" }],
    });
  };
  ...
  const removeAboutItem = (i: number) => {
    ...
    setAboutForm({
      ...aboutForm,
      items: aboutForm.items.filter((_, idx) => idx !== i),
    });
  };

  const updateAboutSkill = (
    i: number,
    field: keyof AboutSkillBar,
    value: string | number,
  ) => {
    if (!aboutForm) return;
  ...
  const addAboutSkill = () => {
    ...
    setAboutForm({
      ...aboutForm,
      skills: [...aboutForm.skills, { name: "", percentage: 50 }],
    });
  };
  ...
  const removeAboutSkill = (i: number) => {
    ...
    setAboutForm({
      ...aboutForm,
      skills: aboutForm.skills.filter((_, idx) => idx !== i),
    });
  };
      ...
      <div style={{ maxWidth: "860px", margin: "0 auto" }}>
        ...
        <div
          style={{
            ...s.card,
            padding: pad,
            borderColor: editingProject ? "#007ced" : "#2a2a2a",
          }}>
          <div
            style={{
              fontSize: "1.1rem",
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: "1rem" }}>
              ...
              <input
                ...
                onChange={(e) =>
                  setForm({ ...form, mainStack: e.target.value })
                }
                ...
                <div key={name} style={s.techChip}>
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ fontSize: "0.82rem", color: "#888" }}>
                      {form.techStack[name] || <em>No description</em>}
                    </div>
                  </div>
                  <button
                    type="button"
                ...
                <div>
                  ...
                  {/[.#$[\]/]/.test(newTech.name) && (
                    <div
                      ...
                      Dots/special chars will be removed from the key (e.g.
                      "Next.js" → "Nextjs")
                    </div>
                  )}
                </div>
            ...
            <div
              ...
              <button
                style={isMobile ? { ...s.btn, flex: 1 } : s.btn}
                type="submit"
                disabled={submitting}>
                {submitting
                  ? editingProject
              ...
              {editingProject && (
                <button
                  style={isMobile ? { ...s.ghostBtn, flex: 1 } : s.ghostBtn}
                  type="button"
        ...
        <div style={{ ...s.card, padding: pad }}>
          ...
          <div style={{ marginBottom: "1rem" }}>
            ...
            <input
              style={{ ...s.input, maxWidth: isMobile ? "100%" : "260px" }}
              value={heroForm.brandName ?? ""}
              onChange={(e) =>
                setHeroForm({ ...heroForm, brandName: e.target.value })
              }
              placeholder="MotazSec"
            />
          </div>
          <div
            style={{
              ...
              <div
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setAboutForm({ ...aboutForm, pageTitle: e.target.value })
                    }
                  />
                </div>
                <div>
                  ...
                  <div
                    ...
                    <div
                      ...
                      <input
                        ...
                        placeholder="Emoji"
                        onChange={(e) =>
                          updateAboutItem(i, "icon", e.target.value)
                        }
                      />
                      <input
                        style={s.input}
                        ...
                        placeholder="Title"
                        onChange={(e) =>
                          updateAboutItem(i, "title", e.target.value)
                        }
                      />
                      <button
                        type="button"
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        updateAboutItem(i, "description", e.target.value)
                      }
                    />
                  </div>
                ))}
                <button type="button" style={s.ghostBtn} onClick={addAboutItem}>
                  + Add Item
                </button>
              </div>
              ...
              <div style={{ marginBottom: "1.25rem" }}>
                ...
                {aboutForm.skills.map((skill, i) => (
                  <div
                    ...
                    style={{
                      display: "grid",
                      gridTemplateColumns: "1fr 90px 50px auto",
                      gap: "0.5rem",
                      marginBottom: "0.5rem",
                      alignItems: "center",
                    }}>
                    <input
                      ...
                      onChange={(e) =>
                        updateAboutSkill(i, "name", e.target.value)
                      }
                    />
                    <input
                      style={s.input}
                      ...
                      onChange={(e) =>
                        updateAboutSkill(i, "percentage", e.target.value)
                      }
                    />
                    <div
                      style={{
